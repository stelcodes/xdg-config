...
if status is-interactive
  ...
  alias dl-video "dl-base --format 'best[height<=1080]'"
  alias dl-best-video "dl-base --format best"
  alias dl-music "dl-base --format 'bestaudio[ext=mp3]' --output '%(title)s - %(album)s [%(id)s].%(ext)s'"
  alias dl-best-music "dl-base --format 'flac / bestaudio[ext=mp3]' --output '%(title)s - %(album)s [%(id)s].%(ext)s'"
  alias dl-best-music-from-video "dl-base --format 'bestaudio' --extract-audio --audio-format opus"
