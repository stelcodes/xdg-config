# Adapted from https://github.com/decors/fish-colored-man
function man --wraps man --description 'Format and display manual pages'
    ...
    set -q man_underline; and set -l underline (set_color $man_underline); or set -l underline (set_color -u green)
